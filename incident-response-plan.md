...
- Aims of an incident response plan: [^3]
...
- Characteristics of an incident response plan: [^3]
	- Should be quick to implement
	- Should be effective
	- Should be transparent
	- Should be able to operate in real-time as the incident progresses

- The Incident Response Plan and the Business Continuity Plan run together hand-in-hand as the incident progresses [^3]
