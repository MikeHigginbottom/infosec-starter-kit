...
- A zero day attack is an attack on a computer system which exploits a vulnerability of which the software or anti-malware vendor is not aware. [^1]
- Day Zero is the day a new vulnerability is made known. [^2]
## My Notes
