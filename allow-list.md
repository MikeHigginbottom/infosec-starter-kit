# Allow List
- A list of specifically trusted actions, resources or destinations that a user, system or application can access [^3] [^1] #glossary
...
- The allow list is often a list of the file name, path, file size and hash value of the approved software. Any code that is not on the list, whether benign or malicious, will not be able to execute on the protected system. [^2]
## My Notes
