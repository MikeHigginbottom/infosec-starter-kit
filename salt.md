# Salt
- A variable passed into a cryptographic algorithm or [Pseudorandom Number Generator](pseudo-random-number-generator.md) to improve randomness/strength. [^1] #glossary
